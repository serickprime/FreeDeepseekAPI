...
function createSetupController({ root = path.resolve(__dirname, '..'), launchTerminal = visiblePowerShell } = {}) {
  ...
  async function action(name) {
    ...
    if (name === 'opencode') {
      ...
      const pid = await launchTerminal(root, 'opencode.cmd --model deepseek-web/deepseek-reasoner');
